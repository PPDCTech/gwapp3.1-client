...
// import { updateRequisition, updateRequisitionStatus } from "../services/api/requisition.api";
...
// 	console.log(isMessageModalOpen)
...
// 		) {
// 			return alert("You are not authorized to cancel", "error");
// 		}
...
// 		if (!message) {
// 			return alert("Please enter a reason", "warning");
// 		}
...
// 				if (isSendBack) {
// 					handleStatusChange(id, "Sent back");
// 				} else {
...
// 			return alert("A Budget Holder must check first", "warning");
// 		}
...
// 			await updateRequisition(id, updateReqData);
// 			await handleStatusChange(id, "Budget check");
// 		} catch (error) {
// 			toast.error(error);
// 		} finally {
// 			handleClose();
...
// 			user?.accessLevel !== "fullAccess"
// 		) {
// 			return alert("A Finance Checker must check first", "warning");
// 		}
...
// 			await updateRequisition(id, updateReqData);
// 			await handleStatusChange(id, "Finance check");
// 		} catch (error) {
// 			toast.error(error);
// 		} finally {
// 			handleClose();
...
// 			user?.accessLevel !== "fullAccess"
// 		) {
// 			return alert("Must be reviewed by Finance", "warning");
// 		}

// 		const code = accountCode;

// 		if (!code) {
// 			return alert("Missing Account code!\nCan't mark as checked", "warning");
// 		}
...
// 			await updateRequisition(id, updateReqData);
// 			await handleStatusChange(id, "Finance review");
// 		} catch (error) {
// 			toast.error(error);
// 		} finally {
// 			handleClose();
...
// 			return alert("You do not have approval access", "warning");
// 		}
...
// 														onChange={(e) =>
// 															setBudgetLine(
// 																budgetCodes?.find((code) => code._id === e.target.value) ||
// 																	null,
// 															)
// 														}
// 													>
