          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                {!isVendor && <TableCell>Action</TableCell>}
              </TableRow>
            </TableHead>
            <TableBody>
              {accounts.map((account) => (
                ...
                >
                  ...
                  {!isVendor && (
                    <TableCell>
                      {editId === account._id ? (
                        <IconButton onClick={() => handleSaveClick(account._id)} aria-label="save">
                        ...
                        <>
                          <IconButton onClick={() => onDelete(account._id)} aria-label="delete">
